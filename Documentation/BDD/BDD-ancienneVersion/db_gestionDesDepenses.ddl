...
CREATE TABLE t_users (
     ...
     CONSTRAINT FK_t_users_roles FOREIGN KEY (idRoles) REFERENCES t_roles(idRoles)
);
...
CREATE TABLE t_expenses (
	 ...
	 CONSTRAINT FK_t_expenses_payer FOREIGN KEY (idPayer) REFERENCES t_users(idUser),
     CONSTRAINT PK_t_expenses PRIMARY KEY (idExpenses)
);
...
CREATE TABLE t_activityExpenses (
     ...
     CONSTRAINT FK_t_activityExpenses_activities FOREIGN KEY (idActivities) REFERENCES t_activities(idActivities),
     CONSTRAINT FK_t_activityExpenses_expenses FOREIGN KEY (idExpenses) REFERENCES t_expenses(idExpenses)
);
...
CREATE TABLE t_create (
     ...
     CONSTRAINT FK_create_activities FOREIGN KEY (idActivities) REFERENCES t_activities(idActivities),
     CONSTRAINT FK_create_users FOREIGN KEY (idUsers) REFERENCES t_users(idUsers)
);

CREATE TABLE t_activityUsers (
     idActivity INT NOT NULL,
     idUser INT NOT NULL,
     CONSTRAINT PK_t_activity_users PRIMARY KEY (idActivity, idUser),
     CONSTRAINT FK_t_activity_users_activities FOREIGN KEY (idActivity) REFERENCES t_activities(idActivity),
     CONSTRAINT FK_t_activity_users_users FOREIGN KEY (idUser) REFERENCES t_users(idUser)
);
...
CREATE TABLE t_expenseUsers (
     ...
     CONSTRAINT FK_t_expense_users_expenses FOREIGN KEY (idExpense) REFERENCES t_expenses(idExpense),
     CONSTRAINT FK_t_expense_users_users FOREIGN KEY (idUser) REFERENCES t_users(idUser)
);
